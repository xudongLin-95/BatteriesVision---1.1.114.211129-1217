...
#define H_ERR_HCPUDNN_ERROR               4300 /* Error occurred in HCPUDNN library */
#define H_ERR_TRAINING_UNSUPPORTED        4301 /* Training is unsupported with
                                                  the selected runtime. Please switch to
                                                  'gpu' runtime. */
#define H_ERR_HCPUDNN_NOT_AVAILABLE       4302 /* CPU based inference is not
...
#define H_ERR_DL_FILE_READ            7780 /* DL: Error writing file */
#define H_ERR_DL_FILE_WRITE           7781 /* DL: Error reading file */
