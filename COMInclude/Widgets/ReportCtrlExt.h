...
// ReportCtrlExt.h
//
// CReportCtrlExt, a CListCtrl derived class that is specialized on "Report View"
// style. 
//
// Features:
//
...
//                 are multiple CReportCtrlExt objects on same window.
// 7. 04, 2016   - 增加了表头颜色的编辑，添加了CHeaderCtrlExtCl类
///////////////////////////////////////////////////////////////////////////////

#ifndef __REPORTCTRLEXT_H__
#define __REPORTCTRLEXT_H__
...
//////////////////////////////////////////////////////////////////////////
// The CReportCtrlExt Class Definition
//////////////////////////////////////////////////////////////////////////
struct ROWINFO
{
	DWORD dwData;
...
class W_LIB CReportCtrlExt : public CListCtrl
{
public:		
	...
	//ColorHeader
	void SetColorHeader(BOOL bColor = FALSE);
	void SetHeaderBKColor(int R, int G, int B, int Gradient);// Gradient - 渐变系数，立体背景用,不用渐变设为0
	void SetHeaderHeight(float Height);//设置表头的高度，需要在插入列之前设置
	...
	const CHeaderCtrlExt* GetHeaderCtrl() const;
...
protected:	
	...
	BOOL          m_bColorHeader;//是否使用彩色表头功能
	//////////////////////////////////////////////////////////////////////
	// Wizard Generated Stuff
	//////////////////////////////////////////////////////////////////////

	// ClassWizard generated virtual function overrides
	//{{AFX_VIRTUAL(CReportCtrlExt)
	public:
...
//////////////////////////////////////////////////////////////////////////
// End of CReportCtrlExt Class Definition
//////////////////////////////////////////////////////////////////////////
