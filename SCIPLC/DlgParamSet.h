...
public:
	...
	double m_EDIT_dKnifeAlertDiff;
	double m_EDIT_dKnifeUnit;
	double m_EDIT_dKnifeCorrectPercent;
	int m_EDIT_nLeftKnifeCorrectAddr;
	int m_EDIT_nRightKnifeCorrectAddr;
	int m_EDIT_nKnifeCorrectDoAddr;
	int m_EDIT_nKnifeCorrectFinishAddr;
	int m_EDIT_nLeftKnifePosAddr;
	int m_EDIT_nRightKnifePosAddr;
	double m_EDIT_dKnifeAlertMinDiff;
	double m_EDIT_dCamKnifeDistance;
	double m_EDIT_dKnifeCorrectInterval;
	double m_EDIT_dKnifeStartIngoreMeter;
	double m_EDIT_dBateRayDistance;
	double m_EDIT_dBetaRayMaxWeightDiff;
	INT m_Edit_nProductTypeAddr;
	int m_Edit_nPlcSoftwareVersionAddr;
	int m_Edit_nReadProductType_Addr;
};
