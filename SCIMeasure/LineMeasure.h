...
public:
	...
	{
		PRE_None = 0,			//无
		PRE_BaseCoatWet,		//凹版湿膜
		PRE_AT11Virtual,		//AT11虚边
		PRE_PointFilter,		//点筛选拟合
	};
...
private:
	...
	int  _FindLine(const HObject& Image, const int nSN, const tagLineParam& FitLinePara, HObject* Line,
		double* dStartY, double* dStartX, double* dEndY, double* dEndX, int nFitSingleLine = 0,int nLineDisplay = 0);
	//极耳或者涂布的四个角点
	...
	BOOL _SegmentEdge(const HObject& Image, const HTuple& hvRow, const HTuple& hvCol, const tagLineParam& FitLinePara,
