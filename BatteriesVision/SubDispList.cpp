...
void CSubDispList::InitUI()
{
	...
	m_TAB_List.InsertItem(4, bChinese ? "瑕疵图像查询" : "Inquire  Data");
	...
	m_pPageDispInquire = new CPageDispList5;
	m_pPageDispInquire->Create(CPageDispList5::IDD, this);
	m_pPageDispInquire->MoveWindow(rcSubDlg);
	m_pPageDispInquire->ShowWindow(SW_HIDE);
	m_pPageDispInquire->ResetSize();
	m_vecPages.push_back(m_pPageDispInquire);
}
