...
void CPageSystemSet::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EDIT_SPOTINSPECTION_TIME, m_EDIT_nSpotInspectionTime);
...
BEGIN_MESSAGE_MAP(CPageSystemSet, CBCGPDialog)
	...
	ON_EN_CHANGE(IDC_EDIT_SPOTINSPECTION_TIME, &CPageSystemSet::OnEnChangeEditSpotinspectionTime)
...
void CPageSystemSet::InitUI()
{
	...
	m_EDIT_nSpotInspectionTime = theGlobal.m_tSystemSet.nSpotInspectionIntervalSecond;
...
void CPageSystemSet::OnEnChangeEditSpotinspectionTime()
{
	UpdateData(TRUE);
	theGlobal.m_Log.Operate(theGlobal.m_tSystemSet.nSpotInspectionIntervalSecond, m_EDIT_nSpotInspectionTime, "点检间隔时间(秒)");
	theGlobal.m_tSystemSet.nSpotInspectionIntervalSecond = m_EDIT_nSpotInspectionTime;
	theGlobal.WriteParam();
}
