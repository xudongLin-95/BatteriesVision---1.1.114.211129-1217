...
BOOL CGlobal::ReadParam()
{
	...
	//m_tSystemSet.bUseSpotInspection = GetIniInt("System", "UseSpotInspection", FALSE);
	m_tSystemSet.nSpotInspectionIntervalSecond = GetIniInt("System", "SpotInspectionIntervalSecond", 300);

	//m_tSystemSet.strOffsetServerIP = GetIniString("System", "strOffsetServerIP", "127.0.0.1");
	//m_tSystemSet.nOffsetServerPort = GetIniInt("System", "nOffsetServerPort", 6000);
...
BOOL CGlobal::WriteParam()
{
	...
	//WriteIniInt("System", "UseSpotInspection", m_tSystemSet.bUseSpotInspection);
	WriteIniInt("System", "SpotInspectionIntervalSecond", m_tSystemSet.nSpotInspectionIntervalSecond);

	//WriteIniDouble("System", "dEnableOffsetSpeed", m_tSystemSet.dEnableOffsetSpeed);
	//WriteIniString("System", "strOffsetServerIP", m_tSystemSet.strOffsetServerIP);
    //WriteIniInt("System", "nOffsetServerPort", m_tSystemSet.nOffsetServerPort);
